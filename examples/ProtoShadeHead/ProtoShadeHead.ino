...
//
// Needs partitions.csv selected as a custom partition scheme: the .bin lives in its own
// flash partition, so it survives power loss and costs no RAM (esp_partition_mmap maps it
